...
*/
    ...
    ///动画时长
    public var animateTime:TimeInterval = 1
    ///动画延迟时间
    public var animateDelay:TimeInterval = 1
    ///关闭回调
    ...
    public init (tips:String,
        ...
        removeWithAnimate(time: animateTime, delay: delay)
    }
...
extension PopView{
    ...
    private func changeState(){
        ...
        case .success: //加载成功
            ...
            removeWithAnimate(time: animateTime, delay: animateDelay)
        case .error: //加载失败
            stateImv.layer.removeAnimation(forKey: "transform.rotation.z")
    ...
    ///   - time: 动画持续时间
    ///   - delay: 延迟
    private func removeWithAnimate(time:CGFloat, delay:TimeInterval){
