...
//        print("")
        YLPop.tips(text: "蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击蒙层按钮点击")
    }
}
